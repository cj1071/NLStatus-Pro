...
import '../../styles/trust-level.css';
import '../../styles/leaderboard.css';
import '../../styles/activity.css';
import '../../styles/ai-summary.css';
import '../../styles/topic-export.css';
...
import { NavBarEnergy } from '../nav/nav-bar-energy';
import { createPanelTemplate } from './template';
import { PanelChrome } from './chrome';
import { ActivityPanel } from '../panels/activity-panel';
import { FollowPanel } from '../panels/follow-panel';
import { LeaderboardPanel } from '../panels/leaderboard-panel';
import { ProfileActions } from '../components/profile-actions';
import { ThemeController } from '../nav/theme-controller';
import { LoginPrompt } from '../components/login-prompt';
import { TrustPanel } from '../panels/trust-panel';
import { TabController } from '../components/tab-controller';
import { ResizeController } from '../components/resize-controller';

import type { PanelElementMap } from './template';
